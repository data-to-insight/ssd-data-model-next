...
DECLARE @VERSION nvarchar(32) = N'0.1.0'; -- dev check .toml 
...
/*
=============================================================================
EA LITE deployment toggle on/off as SSD data available | default = OFF
============================================================================= */

DECLARE @IncludeHealthAndWellbeing bit = 0;

DECLARE @IncludeAssessments         bit = 0;
DECLARE @IncludeCINPlans            bit = 0;
DECLARE @IncludeS47                 bit = 0;
DECLARE @IncludeCPPlans             bit = 0;

DECLARE @IncludePlacements          bit = 0;
DECLARE @IncludeAdoption            bit = 0;
DECLARE @IncludeCareLeavers         bit = 0;
DECLARE @IncludeCareWorkers         bit = 0;

/*
LITE starting payload profile:

LITE Included default:
    - child_details
        ...
        (
            ...
            SELECT
                ...
                */
                ...
                JSON_QUERY(
                    CASE
                        WHEN @IncludeHealthAndWellbeing = 1
                        THEN
                            (
                                SELECT
